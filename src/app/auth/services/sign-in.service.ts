...
export class SignInService {
  ...
  getImageUrl(): Observable<object[]> {
    ...
    for (let i of Array.from({ length: 5 }, (_, i) => 1 + (i))) {
      images.push({ contentUrl: `./assets/images/lbg${i}.jpg` })
    }
    return of(images)
