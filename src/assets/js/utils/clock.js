...
const covertToCivilianTime = clockTime => compose(appendAMPM, civilianHours)(clockTime);
...
const startTicking = () => setInterval(compose(clear, getCurrentTime, serializeClockTime, covertToCivilianTime, doubleDigits, formatClock('hh:mm:ss tt'), display(log)), oneSecond())
startTicking()